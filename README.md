...
Output is validated per-scene against golden outputs from the CUDA reference — see [VALIDATION.md](VALIDATION.md).
...
| GlassPour | 41.4s | 34.9s | 5.2s |
| LegoDrop | 13.7s | 10.0s | 2.7s |
| SpollingBowl | 83.5s | 61.3s | 6.5s |
| FillerUp | 72.2s | 90.2s | 26.9s |
| Trumpet | 45.4s | 76.8s | 31.5s |
| TalkFan | 132.2s | 128.2s | 41.5s |
| HandShake | 102.5s | 124.9s | 45.7s |
| 2016Pour | 127.4s | 187.0s | 73.1s |
| PaddleSplash | 615.1s | 400.5s | 54.2s |
| **Total** | **1254.9s** | **1170.0s** | **316.2s** |
